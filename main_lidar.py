...
if __name__ == "__main__":
    ...
    r_in, r_out, plane_model_r = ransac(right, 0.005, 3, 500, "Right")
    l_in, l_out, plane_model_l = ransac(left, 0.005, 3, 500, "Left")
    t_in, t_out, plane_model_t = ransac(top, 0.005, 3, 500, "Top")
    # r = toPointCloud(r_in)
    # l = toPointCloud(l_in)
    # t = toPointCloud(t_in)
